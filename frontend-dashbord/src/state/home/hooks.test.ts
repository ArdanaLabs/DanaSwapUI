...
describe('Home hooks', () => {
  ...
  it('should return stored total stats', () => {
    ...
    expect(totalDepositsAllPoolsUSD).toEqual(store.getState().home.totalDepositsAllPoolsUSD)
    expect(totalDailyVolumeUSD).toEqual(store.getState().home.totalDailyVolumeUSD)
    expect(totalDailyFeeVolumeUSD).toEqual(store.getState().home.totalDailyFeeVolumeUSD)
    expect(totalLiquidityUtilization).toEqual(store.getState().home.totalLiquidityUtilization)
  })
